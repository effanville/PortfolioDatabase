...
namespace Effanville.FPD.Logic.Tests.UserInteractions
{
    ...
    {
        public static DataNamesViewModel GetDataNamesViewModel(this MainWindowViewModel viewModel)
            => (DataNamesViewModel)viewModel.Tabs.First(tab => tab is DataNamesViewModel);

        public static SelectedSingleDataViewModel SelectedTab(this MainWindowViewModel viewModel, NameData name)
        {
        ...
        public static SelectedAssetViewModel SelectedAssetTab(this MainWindowViewModel viewModel, NameData name)
        {
        ...
        public static SelectedSecurityViewModel SelectedSecurityTab(this MainWindowViewModel viewModel, NameData name)
        {
