...
namespace Effanville.FPD.Logic.Tests
{
    public class OptionsToolbarTests
    {
        ...
        public void CanOpenNewDatabase()
        {
            ...
            OptionsToolbarViewModel viewModel = new OptionsToolbarViewModel(TestSetupHelper.CreateGlobalsMock(fileSystem, fileMock.Object, dialogMock.Object), null, portfolio, null);
        ...
        public void CanOpenDatabase()
        {
            ...
            IUpdater<IPortfolio> dataUpdater = TestSetupHelper.CreateUpdater(portfolio);
            OptionsToolbarViewModel viewModel = new OptionsToolbarViewModel(TestSetupHelper.CreateGlobalsMock(tempFileSystem, fileMock.Object, dialogMock.Object), null, portfolio, null);
            viewModel.UpdateRequest += dataUpdater.PerformUpdate;
