...
namespace FinancialStructures.StatsMakers
{
    ...
    public static class PortfolioStatsCreators
    {
        private static void WriteSectorAnalysis(StreamWriter writer, IPortfolio portfolio, UserOptions options)
        {
            ...
            SecurityStatistics temp = new SecurityStatistics();
        ...
        public static bool CreateHTMLPageCustom(IPortfolio portfolio, string filepath, UserOptions options)
        {
            ...
            DayValue_Named securityTotals = new DayValue_Named("Securities", string.Empty, DateTime.Today, portfolio.TotalValue(AccountType.Security));
            ...
            DayValue_Named portfolioTotals = new DayValue_Named("Portfolio", string.Empty, DateTime.Today, portfolio.Value(DateTime.Today));
