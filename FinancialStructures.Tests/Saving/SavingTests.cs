...
namespace FinancialStructures.Tests.Saving
{
    ...
    {
        private static IEnumerable<(string name, IPortfolio testPortfolio, string XmlString)> TestLists()
        {
        ...
        [TestCaseSource(nameof(WriteSerializationData), new object[] { nameof(ReadXmlTests) })]
