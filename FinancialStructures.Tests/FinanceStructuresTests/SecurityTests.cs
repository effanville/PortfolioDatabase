        ...
        public static IEnumerable<TestCaseData> TradeData()
        {
            ...
            yield return new TestCaseData(
                ...
                new[] {
                    ...
                    (new DateTime(2018, 5, 6), 77.700000000000003, 29.0, 0.0),
                    (new DateTime(2020, 1, 1), 101.09999999999999, 28.800000000000001, 0.0)
                }).SetName("Four");
            yield return new TestCaseData(
                SecurityConstructor.Default().Item,
                ...
                new[] {
                    ...
                    (new DateTime(2011, 1, 1), 100.0, 9.5, 0.0),
                    (new DateTime(2012, 5, 1), 125.2, 25.300000000000001, 0.0),
                    (new DateTime(2015, 4, 3), 90.599999999999994, 12.0, 0.0),
                    (new DateTime(2018, 5, 6), 77.700000000000003, 13.699999999999999, 0.0),
                    (new DateTime(2020, 1, 1), 101.09999999999999, 13.5, 0.0)
                }).SetName("Five");
            yield return new TestCaseData(
                SecurityConstructor.Default().Item,
