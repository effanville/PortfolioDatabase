...
namespace FinancialStructures.Tests.Database.Statistics
{
    ...
    {
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.All, "2010 /1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.All, "2011/1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.All, "2012/1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.All, "2013/1/1", "2019/1/1", 0.06494140625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.All, "2014/1/1", "2019/1/1", 0.09423828125)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.Security, "2010 /1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.Security, "2011/1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.Security, "2012/1/1", "2019/1/1", 0.05322265625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.Security, "2013/1/1", "2019/1/1", 0.06494140625)]
        [TestCase(TestDatabaseName.TwoSecTwoBank, Totals.Security, "2014/1/1", "2019/1/1", 0.09423828125)]
