...
namespace FinanceCommonViewModels
{
    public class SingleValueEditWindowViewModel : PropertyChangedBase
    {
        ...
        public SingleValueEditWindowViewModel(Portfolio portfolio, List<Sector> sectors, Action<bool> updateWindow, Action<ErrorReports> updateReports, EditMethods editMethods)
        {
